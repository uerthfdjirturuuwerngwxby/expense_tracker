...
const TRANSACTIONS = [
  { emoji: "☕", name: "Starbucks",    amt: "-$5.40",  color: "#ef4444", delay: 0    },
  { emoji: "🛒", name: "Groceries",   amt: "-$62.30", color: "#f97316", delay: 500  },
  { emoji: "💰", name: "Salary",      amt: "+$4,200", color: "#10b981", delay: 1000 },
  { emoji: "🎬", name: "Netflix",     amt: "-$15.99", color: "#ef4444", delay: 1500 },
  { emoji: "⚡", name: "Electricity", amt: "-$88.00", color: "#f97316", delay: 2000 },
];
...
export default function Login() {
  ...
  const handleGoogle = () => {
    setGoogleBusy(true);
    setError("");
    loginWithGoogle(); // redirects away, no try/catch needed
  };
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        .tx-ic { width:34px; height:34px; border-radius:10px; background:#f1f5f9; display:flex; align-items:center; justify-content:center; font-size:16px; flex-shrink:0; }
              ...
              {TRANSACTIONS.map(tx => (
                <div className="tx-row" key={tx.name} style={{ animationDelay: `${tx.delay + 500}ms` }}>
                  <div className="tx-l">
                    ...
                    <div><div className="tx-nm">{tx.name}</div><div className="tx-tm">Just now</div></div>
                  </div>
